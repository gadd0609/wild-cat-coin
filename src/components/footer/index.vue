			...
			<div class="flex flex-row justify-center pt-6 lg:pt-0">
				<div class="flex justify-center space-x-6">
					<a 
						...
						href="https://x.com/wildcatcoin"
						title="X"
						class="flex items-center justify-center w-8 h-8 rounded-full sm:w-10 sm:h-10 bg-coin border-2 border border-coin-200 dark:border-coin-200 dark:text-gray-50">
					...
					<a
						rel="noopener noreferrer"
						href="https://t.me/+SWJlpGMKJXZiODEx"
						title="Telegram"
						class="flex items-center justify-center w-8 h-8 rounded-full sm:w-10 sm:h-10 bg-coin border-2 border border-coin-200 dark:border-coin-200 dark:text-gray-50">
                        <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="30" height="100" viewBox="0,0,256,256">
